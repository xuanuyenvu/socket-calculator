The Socket Calculator project is a simple client-server application written in C++. This application allows one server to connect with multiple clients over a network connection.
